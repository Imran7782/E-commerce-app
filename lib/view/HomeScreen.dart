...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    String currentlocal=locale.languageCode;
                      ...
                      Badge(
                        ...
                        child: IconButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              Components().ScreenTransitions(CartPage()),
                            );
                          },
                          icon: const Icon(
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Align(
                        alignment: currentlocal=='en'? Alignment.centerLeft:Alignment.centerRight,
                        child: Text(
                          "categories".tr(),
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Align(
                                      alignment: Alignment.centerLeft,
                                      child: Text(
                                        "We_write_the_product_descrption_here".tr(),
                                        style: GoogleFonts.dmSerifText(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 16,
                                          color: Colors.black54,
